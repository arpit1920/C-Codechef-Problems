...
sudden turn and he runs into a financial crisis.
...
N and M, the length and the breadth of the land, respectively.

Output
For each test case, print the minimum number of square plots with equal area,
such that they divide the farm land perfectly, in a new line.
