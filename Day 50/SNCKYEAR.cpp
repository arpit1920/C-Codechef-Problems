/*
Chef is interested in the history of SnackDown contests.
He needs a program to verify if SnackDown was hosted in a given year.
...
if SnackDown was hosted in year N or "NOT HOSTED" otherwise (without quotes).
