/*
Chef loves to play with arrays by himself.
...
Input
First line of input contains a single integer T denoting the number 
of test cases.
...
Explanation
Test 1 : Chef will make only 1 move: pick up both the elements (that is, 3 and 4),
